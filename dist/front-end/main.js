...
module.exports = "<div class=\"col-md-5 form-group mt-5\">\n  <label for=\"\">Address</label>\n  <input \n    type=\"text\" \n    placeholder=\"Please enter an address\" \n    name=\"address\" \n    class=\"form-control\">\n</div>\n"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(block) {
        this.block = block;
    }
    DashboardComponent.prototype.ngOnInit = function () {
        this.block.getBlocks(2).subscribe(function (data) {
            console.log(data);
        });
    };
...
module.exports = "<nav class=\"navbar navbar-dark bg-dark\">\n  <a class=\"navbar-brand\" href=\"#\">BlockFinder</a>\n</nav>"
...
var BlockService = /** @class */ (function () {
    ...
    BlockService.prototype.getBlocks = function (blockNumber) {
        return this.http.post(this.URL + 'getBlock', { blocks: blockNumber });
    };
    BlockService.prototype.getTransaction = function (address) {
        return this.http.post(this.URL + 'getTransaction', { address: address });
    };
...
module.exports = __webpack_require__(/*! /home/userone/Desktop/Untitled Folder 2/front-end/src/main.ts */"./src/main.ts");
